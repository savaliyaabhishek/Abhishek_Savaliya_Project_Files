...
def run(
        weights=ROOT / 'best1.pt',  # model path or triton URL
        source=ROOT / 'static/uploads',  # file/dir/URL/glob/screen/0(webcam)
        ...
        project=ROOT / 'static/annotated',  # save results to project/name
